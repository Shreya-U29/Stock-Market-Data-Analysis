...
company_list = [
    'C:\\Users\\PCL\\Desktop\\pbi\\python_projects\\S&P_resources\\individual_stocks_5yr\\AAPL_data.csv',
    'C:\\Users\\PCL\\Desktop\\pbi\\python_projects\\S&P_resources\\individual_stocks_5yr\\AMZN_data.csv',
    'C:\\Users\\PCL\\Desktop\\pbi\\python_projects\\S&P_resources\\individual_stocks_5yr\\GOOG_data.csv',
    'C:\\Users\\PCL\\Desktop\\pbi\\python_projects\\S&P_resources\\individual_stocks_5yr\\MSFT_data.csv'
]
...
st.set_page_config(page_title = "Stock Analsyis Dashboard", layout='wide')
...
fig2 = px.line(company_df, x='date', 
               y=['close', 'close_10','close_20', 'close_50'], title = selected_company + 'closing prices with moving average')
